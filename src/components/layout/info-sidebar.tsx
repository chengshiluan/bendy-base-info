...
export function InfoSidebar({
  ...
  const defaultData = {
    title: translate('infobar.defaultTitle'),
    sections: [
      {
        title: translate('infobar.defaultSectionTitle'),
        description: translate('infobar.defaultSectionDescription'),
        links: [
          {
            title: translate('infobar.defaultLinkTitle'),
            url: '#'
          }
        ]
      }
