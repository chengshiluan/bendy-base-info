...
values
  ...
  ('dashboard.workspaces.menu', '工作区菜单', 'dashboard.workspaces', 'menu', 'global', 'menu', null, '/dashboard/workspaces', 200, true, '允许展开工作区功能目录和全局工作区入口。'),
  ('dashboard.workspaces.manage.menu', '管理工作区菜单', 'dashboard.workspaces.manage', 'menu', 'global', 'menu', 'dashboard.workspaces.menu', '/dashboard/workspaces', 300, true, '允许通过工作区切换器或其他隐藏入口访问工作区管理页。'),
  ('dashboard.workspaces.manage.create', '新增工作区', 'dashboard.workspaces.manage', 'create', 'global', 'action', 'dashboard.workspaces.manage.menu', '/dashboard/workspaces', 301, true, '允许新增系统工作区。'),
  ('dashboard.workspaces.manage.update', '编辑工作区', 'dashboard.workspaces.manage', 'update', 'global', 'action', 'dashboard.workspaces.manage.menu', '/dashboard/workspaces', 302, true, '允许编辑工作区基础资料。'),
  ('dashboard.workspaces.manage.archive', '归档工作区', 'dashboard.workspaces.manage', 'archive', 'global', 'action', 'dashboard.workspaces.manage.menu', '/dashboard/workspaces', 303, true, '允许归档工作区并停止在切换器中显示。'),
  ('dashboard.workspaces.teams.menu', '团队管理菜单', 'dashboard.workspaces.teams', 'menu', 'workspace', 'menu', 'dashboard.workspaces.menu', '/dashboard/workspaces/teams', 400, true, '允许访问团队管理页。'),
  ('dashboard.workspaces.teams.create', '新增团队', 'dashboard.workspaces.teams', 'create', 'workspace', 'action', 'dashboard.workspaces.teams.menu', '/dashboard/workspaces/teams', 401, true, '允许在当前工作区新增团队。'),
  ('dashboard.workspaces.teams.update', '编辑团队', 'dashboard.workspaces.teams', 'update', 'workspace', 'action', 'dashboard.workspaces.teams.menu', '/dashboard/workspaces/teams', 402, true, '允许编辑团队基础资料、负责人和成员。'),
  ('dashboard.workspaces.teams.delete', '删除团队', 'dashboard.workspaces.teams', 'delete', 'workspace', 'action', 'dashboard.workspaces.teams.menu', '/dashboard/workspaces/teams', 403, true, '允许删除当前工作区的团队。'),
  ('dashboard.workspaces.teams.import', '导入团队成员', 'dashboard.workspaces.teams', 'import', 'workspace', 'action', 'dashboard.workspaces.teams.menu', '/dashboard/workspaces/teams', 404, true, '允许从 GitHub 搜索成员并加入当前工作区待选列表。'),
  ('dashboard.workspaces.users.menu', '用户管理菜单', 'dashboard.workspaces.users', 'menu', 'workspace', 'menu', 'dashboard.workspaces.menu', '/dashboard/workspaces/users', 500, true, '允许访问工作区用户管理页。'),
  ('dashboard.workspaces.users.create', '新增用户', 'dashboard.workspaces.users', 'create', 'workspace', 'action', 'dashboard.workspaces.users.menu', '/dashboard/workspaces/users', 501, true, '允许录入新的工作区成员。'),
  ('dashboard.workspaces.users.update', '编辑用户', 'dashboard.workspaces.users', 'update', 'workspace', 'action', 'dashboard.workspaces.users.menu', '/dashboard/workspaces/users', 502, true, '允许修改成员资料、状态和角色。'),
  ('dashboard.workspaces.users.delete', '删除用户', 'dashboard.workspaces.users', 'delete', 'workspace', 'action', 'dashboard.workspaces.users.menu', '/dashboard/workspaces/users', 503, true, '允许删除工作区成员。'),
  ('dashboard.workspaces.roles.menu', '角色管理菜单', 'dashboard.workspaces.roles', 'menu', 'workspace', 'menu', 'dashboard.workspaces.menu', '/dashboard/workspaces/roles', 600, true, '允许访问工作区角色管理页。'),
  ('dashboard.workspaces.roles.create', '新增角色', 'dashboard.workspaces.roles', 'create', 'workspace', 'action', 'dashboard.workspaces.roles.menu', '/dashboard/workspaces/roles', 601, true, '允许创建新的工作区角色。'),
  ('dashboard.workspaces.roles.update', '编辑角色', 'dashboard.workspaces.roles', 'update', 'workspace', 'action', 'dashboard.workspaces.roles.menu', '/dashboard/workspaces/roles', 602, true, '允许调整角色名称、描述和权限集合。'),
  ('dashboard.workspaces.roles.delete', '删除角色', 'dashboard.workspaces.roles', 'delete', 'workspace', 'action', 'dashboard.workspaces.roles.menu', '/dashboard/workspaces/roles', 603, true, '允许删除非系统内置角色。'),
  ('dashboard.workspaces.permissions.menu', '权限管理菜单', 'dashboard.workspaces.permissions', 'menu', 'workspace', 'menu', 'dashboard.workspaces.menu', '/dashboard/workspaces/permissions', 700, true, '允许访问系统权限目录页。'),
  ('dashboard.workspaces.permissions.create', '新增权限', 'dashboard.workspaces.permissions', 'create', 'workspace', 'action', 'dashboard.workspaces.permissions.menu', '/dashboard/workspaces/permissions', 701, true, '允许新增自定义权限项。'),
  ('dashboard.workspaces.permissions.update', '编辑权限', 'dashboard.workspaces.permissions', 'update', 'workspace', 'action', 'dashboard.workspaces.permissions.menu', '/dashboard/workspaces/permissions', 702, true, '允许调整权限定义。'),
  ('dashboard.workspaces.permissions.delete', '删除权限', 'dashboard.workspaces.permissions', 'delete', 'workspace', 'action', 'dashboard.workspaces.permissions.menu', '/dashboard/workspaces/permissions', 703, true, '允许删除非系统权限项。'),
  ('dashboard.workspaces.notifications.menu', '站内消息菜单', 'dashboard.workspaces.notifications', 'menu', 'workspace', 'menu', 'dashboard.workspaces.menu', '/dashboard/workspaces/notifications', 800, true, '允许访问站内消息管理页。'),
  ('dashboard.workspaces.notifications.create', '新增通知', 'dashboard.workspaces.notifications', 'create', 'workspace', 'action', 'dashboard.workspaces.notifications.menu', '/dashboard/workspaces/notifications', 801, true, '允许发布新的工作区通知。'),
  ('dashboard.workspaces.notifications.update', '编辑通知', 'dashboard.workspaces.notifications', 'update', 'workspace', 'action', 'dashboard.workspaces.notifications.menu', '/dashboard/workspaces/notifications', 802, true, '允许修改通知内容与已读状态。'),
  ('dashboard.workspaces.notifications.delete', '删除通知', 'dashboard.workspaces.notifications', 'delete', 'workspace', 'action', 'dashboard.workspaces.notifications.menu', '/dashboard/workspaces/notifications', 803, true, '允许删除工作区通知。'),
  ('dashboard.workspaces.notifications.read', '标记通知已读', 'dashboard.workspaces.notifications', 'read', 'workspace', 'action', 'dashboard.workspaces.notifications.menu', '/dashboard/workspaces/notifications', 804, true, '允许切换工作区通知的已读状态。'),
  ('dashboard.workspaces.tickets.menu', '工单系统菜单', 'dashboard.workspaces.tickets', 'menu', 'workspace', 'menu', 'dashboard.workspaces.menu', '/dashboard/workspaces/tickets', 900, true, '允许访问工单管理页。'),
  ('dashboard.workspaces.tickets.create', '新建工单', 'dashboard.workspaces.tickets', 'create', 'workspace', 'action', 'dashboard.workspaces.tickets.menu', '/dashboard/workspaces/tickets', 901, true, '允许创建新的工单。'),
  ('dashboard.workspaces.tickets.update', '编辑工单', 'dashboard.workspaces.tickets', 'update', 'workspace', 'action', 'dashboard.workspaces.tickets.menu', '/dashboard/workspaces/tickets', 902, true, '允许修改工单标题、描述、优先级和状态。'),
  ('dashboard.workspaces.tickets.delete', '删除工单', 'dashboard.workspaces.tickets', 'delete', 'workspace', 'action', 'dashboard.workspaces.tickets.menu', '/dashboard/workspaces/tickets', 903, true, '允许删除工单及其关联评论。'),
  ('dashboard.workspaces.tickets.assign', '分配工单', 'dashboard.workspaces.tickets', 'assign', 'workspace', 'action', 'dashboard.workspaces.tickets.menu', '/dashboard/workspaces/tickets', 904, true, '允许修改工单负责人。'),
  ('dashboard.workspaces.tickets.comment', '评论工单', 'dashboard.workspaces.tickets', 'comment', 'workspace', 'action', 'dashboard.workspaces.tickets.menu', '/dashboard/workspaces/tickets', 905, true, '允许在工单下提交评论。'),
  ('dashboard.workspaces.tickets.upload', '上传附件', 'dashboard.workspaces.tickets', 'upload', 'workspace', 'action', 'dashboard.workspaces.tickets.menu', '/dashboard/workspaces/tickets', 906, true, '允许为工单和评论上传附件。'),
  ('dashboard.workspaces.kanban.menu', '看板菜单', 'dashboard.workspaces.kanban', 'menu', 'workspace', 'menu', 'dashboard.workspaces.menu', '/dashboard/workspaces/kanban', 1000, true, '允许访问工单看板页。'),
  ('dashboard.workspaces.kanban.update', '更新看板状态', 'dashboard.workspaces.kanban', 'update', 'workspace', 'action', 'dashboard.workspaces.kanban.menu', '/dashboard/workspaces/kanban', 1001, true, '允许通过拖拽更新工单状态。'),
...
join permissions as seeded_permissions
  on seeded_permissions.code in ('dashboard.overview.menu', 'dashboard.workspaces.manage.menu', 'dashboard.workspaces.manage.create', 'dashboard.workspaces.manage.update', 'dashboard.workspaces.manage.archive', 'dashboard.workspaces.teams.menu', 'dashboard.workspaces.teams.create', 'dashboard.workspaces.teams.update', 'dashboard.workspaces.teams.delete', 'dashboard.workspaces.teams.import', 'dashboard.workspaces.users.menu', 'dashboard.workspaces.users.create', 'dashboard.workspaces.users.update', 'dashboard.workspaces.users.delete', 'dashboard.workspaces.roles.menu', 'dashboard.workspaces.roles.create', 'dashboard.workspaces.roles.update', 'dashboard.workspaces.roles.delete', 'dashboard.workspaces.permissions.menu', 'dashboard.workspaces.permissions.create', 'dashboard.workspaces.permissions.update', 'dashboard.workspaces.permissions.delete', 'dashboard.workspaces.notifications.menu', 'dashboard.workspaces.notifications.create', 'dashboard.workspaces.notifications.update', 'dashboard.workspaces.notifications.delete', 'dashboard.workspaces.notifications.read', 'dashboard.workspaces.tickets.menu', 'dashboard.workspaces.tickets.create', 'dashboard.workspaces.tickets.update', 'dashboard.workspaces.tickets.delete', 'dashboard.workspaces.tickets.assign', 'dashboard.workspaces.tickets.comment', 'dashboard.workspaces.tickets.upload', 'dashboard.workspaces.kanban.menu', 'dashboard.workspaces.kanban.update', 'dashboard.ops.menu', 'dashboard.ops.system.menu', 'dashboard.ops.config.menu', 'dashboard.ops.information.menu', 'dashboard.ops.data.menu', 'dashboard.dev.menu', 'dashboard.dev.accounts.menu', 'dashboard.dev.projects.menu', 'dashboard.dev.resources.menu', 'dashboard.admin.menu', 'dashboard.admin.hr.menu', 'dashboard.admin.policies.menu', 'dashboard.admin.governance.menu')
...
where seeded_roles.id = target_role_permissions.role_id
  ...
  and target_role_permissions.permission_id not in (
    select seeded_permissions.id
    from permissions as seeded_permissions
    where seeded_permissions.code in ('dashboard.overview.menu', 'dashboard.workspaces.manage.menu', 'dashboard.workspaces.teams.menu', 'dashboard.workspaces.users.menu', 'dashboard.workspaces.roles.menu', 'dashboard.workspaces.permissions.menu', 'dashboard.workspaces.notifications.menu', 'dashboard.workspaces.notifications.read', 'dashboard.workspaces.tickets.menu', 'dashboard.workspaces.tickets.comment', 'dashboard.workspaces.kanban.menu')
  );
...
from roles as seeded_roles
join permissions as seeded_permissions
  on seeded_permissions.code in ('dashboard.overview.menu', 'dashboard.workspaces.manage.menu', 'dashboard.workspaces.teams.menu', 'dashboard.workspaces.users.menu', 'dashboard.workspaces.roles.menu', 'dashboard.workspaces.permissions.menu', 'dashboard.workspaces.notifications.menu', 'dashboard.workspaces.notifications.read', 'dashboard.workspaces.tickets.menu', 'dashboard.workspaces.tickets.comment', 'dashboard.workspaces.kanban.menu')
left join role_permissions as existing_role_permissions
  on existing_role_permissions.role_id = seeded_roles.id
 and existing_role_permissions.permission_id = seeded_permissions.id
